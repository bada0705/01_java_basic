...
//		}
		...
		finalScore = 95;
		if (finalScore >= 90) {			// 조건식이 true일 때 실행할 명령어 
			System.out.println("A");
		}
		else if (finalScore >= 80) {	// 위 조건식이 false이고 조건식이 true일 때 실행할 명령어
			System.out.println("B");
		}
		else if (finalScore >= 70) {	// 위 조건식이 false이고 조건식이 true일 때 실행할 명령어
